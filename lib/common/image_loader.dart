...
class ImageLoader {
  ...
  static Widget cachedNetworkImage(
    ...
    if (assetName.contains('.svg')) {
      return networkSvg(assetName, height: height, width: width, fit: fit);
    }
    return CachedNetworkImage(
      ...
      placeholder: (context, value) =>
          placeholderWidget ?? CommonFunctions.progressIndicator(),
  ...
  static Widget memory(
    ...
    return Image.memory(selectedImage, height: height, width: width, fit: fit);
  }
}
